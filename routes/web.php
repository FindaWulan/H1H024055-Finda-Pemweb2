...
Route::get('/mahasiswa/H1H024055', function (string $nim) {
    return 'Data mahasiswa dengan NIM H1H024055 ' . $nim;
});

Route::get('/matakuliah/H1H2H1H1H', function (?string $kode = null) {
    if ($kode === null) {
...
Route::get('/semester/5', function (int $angka) {
